                                                    ...
                                                    <table border="0" cellpadding="5" cellspacing="5" width="100%">
                                                       <tr>
                                                           <td valign="top" class="textContent" colspan="3">
                                                                Thanks for registering with eshtihar.com, Please find your password to log in using your email. You can change it after log in.
                                                            <td/>
                                                        </tr>
                                                        <tr>
                                                           <td valign="top" class="textContent" colspan="3">
                                                       ...
                                                       <tr>
                                                           <td valign="top" class="textContent" colspan="3">
                                                                Please note that, you can also log in using your facebook account.
                                                            <td/>
                                                        </tr>                                                        
