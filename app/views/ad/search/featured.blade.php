...
<div id="list-ads" class="row">
    <div class="col-sm-1 list-img">
        ...
        <div class="thumbnail profile-thumb">
            <a href="<?php echo URL::to('/').'/user-profile/'.$ad->user_slug?>"> <img class="img-rounded img-responsive img-hover" src="<?php echo Image::url($src,300,300,array('crop'))?>" alt="<?php echo $ad->title; ?>"> </a>
        </div>
