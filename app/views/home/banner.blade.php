...
<div class="jumbotron eshtihar-banner">
	<div class="container">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                        ...
                        <div class="searchField">
                            <input type="text" name="keyword" id="keyword" autocomplete="off" class="form-control typeahead txtbox-search" id="txt-seach" placeholder="Searching for">
                        </div>
                        ...
                        <div class="click-nav" id="categories">
                            <ul class="no-js">
                                <li>
                                    <a class="clicker cat-clicker" href="javascript:void(0);" onclick="hideSelect();"><i class="glyphicon glyphicon-ok"></i> All Categories</a>
